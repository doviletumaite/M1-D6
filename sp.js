...
//function rollTheDices () {
  let numbersOfDice = dice()*6
  console.log(numbersOfDice)
  
  //for ( let i = 0; numbersOfDice <= 6 ; i ++){
    
 //   let number = numbersOfDice[1] 
 // }
 // arrayOfDice = [number]
//}

//result = rollTheDices ()
//console.log("sum of the numbers of the dice function:",rollTheDices ())
